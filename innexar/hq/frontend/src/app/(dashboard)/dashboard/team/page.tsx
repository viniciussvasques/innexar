...
const mockTeamMembers: TeamMember[] = [
  {
    id: '1',
    name: 'João Silva',
    email: 'joao@innexar.app',
    role: 'SUPER_ADMIN' as UserRole,
    avatar: '',
    status: 'active',
    createdAt: '2024-01-15',
    updatedAt: '2024-01-15',
    lastLogin: '2025-12-28T10:30:00',
    permissions: ['all'],
  },
  {
    id: '2',
    name: 'Maria Santos',
    email: 'maria@innexar.app',
    role: 'ADMIN' as UserRole,
    status: 'active',
    createdAt: '2024-02-20',
    updatedAt: '2024-02-20',
    lastLogin: '2025-12-27T15:45:00',
    permissions: ['users', 'products', 'affiliates'],
  },
  {
    id: '3',
    name: 'Carlos Oliveira',
    email: 'carlos@innexar.app',
    role: 'SUPPORT' as UserRole,
    status: 'active',
    createdAt: '2024-03-10',
    updatedAt: '2024-03-10',
    lastLogin: '2025-12-28T09:15:00',
...
export default function TeamPage() {
  ...
  // Mock query - Substituir por React Query real
  const { data: members = mockTeamMembers } = useQuery({
    queryKey: ['team'],
    queryFn: async () => mockTeamMembers,
  })
